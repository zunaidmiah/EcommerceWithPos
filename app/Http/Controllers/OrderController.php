...
class OrderController extends Controller
{
    ...
    public function all_orders(Request $request)
    {
        ...
        if ($request->courier_status != null) {
            $orders = $orders->where('courier_status', $request->courier_status);
        ...
        return view('backend.sales.index', compact('orders', 'sort_search', 'payment_status', 'delivery_status', 'courier_status',  'date'));
    }
    ...
    public function orderBulkExport(Request $request)
    {
        ...
        foreach ($request->selected_items as $key => $value) {
            return Excel::download(new OrdersExport($value), 'orders.xlsx');
        }
        flash(translate('Your order Export has been done successfully'))->success();
    ...
    //delete all orders 
    public function destroy_all_orders(Request $request)
    {
    ...
    // print the order
    public function print_all_orders(Request $request)
    {
    ...
    public function change_status(Request $request)
    {
        ...
        foreach ($request->selected_items as $key => $value) {
            ...
            $orders->delivery_status = $request->change_status;
            $orders->save();
        }
        flash(translate('order status has been updated successfully'))->success();
        return redirect()->back();
    }
}
