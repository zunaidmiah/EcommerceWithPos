...
class CheckoutController extends Controller
{
    ...
    //   }else{
    //    $this->checkout_without_auth($request);
    ...
    //   die();
       ...
       return $this->checkout_without_auth($request);
    ...
    {   
        ...
        $carts = $carts->fresh();
        $proceed = 0;
    //  dd($carts ,$carrier_list , $shipping_info,);
        return array(
