...
<footer>
    <div class="footer">
        <div class="container ">
            <div class="row ">
                ...
                <div class="col-lg-3 col-md-6">
                    <h3 class="footer-title">{{ translate('Contact Info') }}</h3>
                ...
                <div class="col-xxl-3 col-xl-4 col-lg-4 col-md-6">
                    <div class="footer-widget footer-widget border-bottom">
                        {{--                        social-link--}}
                        <h3 class="footer-title">{{ translate('Follow Us')}}</h3>
                        <!-- Social -->
                        @if ( get_setting('show_social_links') )
                            <ul class="list-inline social colored mb-4 pt-4">
                                @if (!empty(get_setting('facebook_link')))
                                    <li class="list-inline-item ml-2 mr-2">
                                        <a href="{{ get_setting('facebook_link') }}" target="_blank"
                                           class="facebook"><i class="lab la-facebook-f"></i></a>
    ...
    <div class="footer-copy-right">
        <p class="text-center">© 2022 {{ env('APP_NAME') }}. {{ translate('All Rights Reserved') }}.</p>
