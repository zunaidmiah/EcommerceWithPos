    ...
    <section class="my-4 gry-bg">
        <div class="container">
            <div class="row cols-xs-space cols-sm-space cols-md-space">
                    ...
                    <form class="form-default" data-toggle="validator" action="{{ route('payment.checkout') }}" role="form" method="POST" id="checkout-form">
                        ...
                        <div class="accordion" id="accordioncCheckoutInfo">
                            ...
                            <div class="card rounded-0 border shadow-none" style="margin-bottom: 2rem;">
                               <div class="row">
                                <div id="collapseShippingInfo" class="collapse show col-md-12" aria-labelledby="headingShippingInfo" data-parent="#accordioncCheckoutInfo">
                ...
                <div class="card rounded-0 col-lg-4  mt-lg-0 border shadow-none" style="margin-bottom: 2rem; overflow: visible !important;">
...
let url = '{{ route('checkout.updateDeliveryAddress') }}';
url += `?address_id=${id}&city_id=${city_id}`;
            ...
            $(el).change(function(){
                ...
                @if (get_setting('shipping_type') == 'area_wise_shipping')
                    if ($(el).attr('name') == 'city_id') {
                        ...
                        updateDeliveryAddress(18, city_id);
                    }
                @endif
