            ...
            <div class="row">
                <div class="col-xl-8 mx-auto">
                    ...
                    <div class="text-center py-4 mb-0">
                        ...
                        {{--@dd(json_decode($first_order->shipzping_address) )--}}
                        <h1 class="mb-2 fs-28 fw-500 text-success">{{ translate('Thank You for Your Order!')}}</h1>
                        <p class="fs-13 text-soft-dark">{{  translate('A copy or your order summary has been sent to') }} <strong>{{ json_decode($first_order->shipping_address)->email->email ?? "" }}</strong></p>
                    </div>
                    <!-- Order Summary -->
                            ...
                            <div class="col-md-6">
                                <table class="table fs-14 text-soft-dark">
                                    ...
                                    <tr>
                                        ...
                                        {{--@dd(json_decode($first_order->shipping_address)->name)--}}
                                    ...
                                    <tr>
                                        ...
                                        <td class="border-top-0 py-2">{{ json_decode($first_order->shipping_address)->email->email ?? "N/A" }}</td>
                                    </tr>
                                    <tr>
