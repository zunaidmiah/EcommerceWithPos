                ...
                <div class="mt-3">
                    @if ($product->digital == 1)
                        <button type="button" class="btn btn-primary rounded-0 buy-now fw-600 add-to-cart" 
                            @if (Auth::check() || get_Setting('guest_checkout_activation') == 1) onclick="addToCarts()" @else onclick="showLoginModal()" @endif
                        >
                    ...
                    @elseif($qty > 0)
                        ...
                        @else
                            <button type="button" class="btn btn-primary rounded-0 buy-now fw-600 add-to-cart" 
                                @if (Auth::check() || get_Setting('guest_checkout_activation') == 1)   @else onclick="showLoginModal()" @endif
                                @if($product->variant_product == 0) onclick="addToCarts()" @else onclick="addToCart()" @endif
                            >
                                <i class="la la-shopping-cart"></i>
                                <span class="d-none d-md-inline-block">
                                    @if($product->variant_product == 0) {{ translate('Buy Now')}} @else  {{ translate('Add to cart')}} @endif
                                </span>
                            </button>
                        @endif
                    @endif
