...
<div class="row">
    <div class="col-lg-12 mx-auto">
        ...
        <form action="{{ route('landing_page.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" placeholder="{{translate('Title')}}" id="title" name="title" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" placeholder="{{translate('Video')}}" id="top_video" name="top_video_link" class="form-control">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 control-label" for="description">{{translate('Long Description(1)')}}</label>
                            <div class="col-sm-9">
                                {{-- <input type="text" placeholder="{{translate('Long Description')}}" id="description" name="description" class="form-control" required> --}}
                                <textarea class="aiz-text-editor" style="display: none;" name="description"></textarea>
                            </div>
                        </div>
                        <br>
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6">{{translate('Feature Details')}}</h5>
                </div>
                <div class="card-body">
                    <div class="form-group row">
                        <label class="col-sm-3 control-label" for="title_2">{{translate('Title')}}</label>
                        <div class="col-sm-9">
                            <input type="text" placeholder="{{translate('Title')}}" id="title_2" name="title_2" class="form-control">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-3 control-label" for="description_2">{{translate('Long Description(2)')}}</label>
                        <div class="col-sm-9">
                            {{-- <input type="text" placeholder="{{translate('Long Description')}}" id="description" name="description" class="form-control" required> --}}
                            <textarea class="aiz-text-editor" style="display: none;" name="description_2"></textarea>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="{{translate('Title')}}" id="title_3" name="title_3" class="form-control">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <div class="input-group" data-toggle="aizuploader" data-type="image">
                                ...
                                <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                <input type="hidden" name="image_3" class="selected-files">
                            </div>
                            <div class="file-preview box sm">
                            </div>
                            <span class="small text-muted">{{ translate('This image is shown as banner in landing page details page.') }}</span>
                    ...
                    <div class="form-group row">
                        <label class="col-sm-3 control-label" for="description_3">{{translate('Long Description(3)')}}</label>
                        <div class="col-sm-9">
                            {{-- <input type="text" placeholder="{{translate('Long Description')}}" id="description" name="description" class="form-control" required> --}}
                            <textarea class="aiz-text-editor" style="display: none;" name="description_3"></textarea>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="{{translate('Title')}}" id="video_title_1" name="video_title_1" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="{{translate('Video')}}" id="video_1" name="video_1_link" class="form-control">
                        </div>
                    </div>
                </div>
            </div>
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="{{translate('Title')}}" id="video_title_2" name="video_title_2" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="{{translate('Video')}}" id="video_2" name="video_2_link" class="form-control">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <div class="input-group" data-toggle="aizuploader" data-type="image">
                                ...
                                <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                <input type="hidden" name="slider_1" class="selected-files">
                            </div>
                            <div class="file-preview box sm">
                            </div>
                            <span class="small text-muted">{{ translate('This image is shown as slider in landing page details page.') }}</span>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <div class="input-group" data-toggle="aizuploader" data-type="image">
                                ...
                                <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                <input type="hidden" name="slider_2" class="selected-files">
                            </div>
                            <div class="file-preview box sm">
                            </div>
                            <span class="small text-muted">{{ translate('This image is shown as slider in landing page details page.') }}</span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <div class="input-group" data-toggle="aizuploader" data-type="image">
                                ...
                                <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                <input type="hidden" name="slider_3" class="selected-files">
                            </div>
                            <div class="file-preview box sm">
                            </div>
                            <span class="small text-muted">{{ translate('This image is shown as slider in landing page details page.') }}</span>
