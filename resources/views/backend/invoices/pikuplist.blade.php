		...
		<div style="background: #eceff4;padding: 1rem;">
			<table>
				<tr>
					...
					<td style="font-size: 1.5rem;" class="text-right strong">{{  translate('Pickup List') }}</td>
				</tr>
			</table>
			{{--<table>
				<tr>
			...
			<table class="padding text-left small border-bottom">
				<thead>
	                <tr class="gry-color" style="background: #eceff4;">
	                    <th width="35%" class="text-left">{{ translate('Order id') }}</th>
						<th width="15%" class="text-left">{{ translate('Name') }}</th>
	                    <th width="10%" class="text-left">{{ translate('Phone') }}</th>
