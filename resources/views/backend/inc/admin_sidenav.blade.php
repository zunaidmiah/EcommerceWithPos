    ...
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <!-- Reports -->
                @canany(['earning_report', 'in_house_product_sale_report','seller_products_sale_report','products_stock_report','product_wishlist_report','user_search_report','commission_history_report','wallet_transaction_report'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <div class="aiz-side-nav-icon">
                ...
                @endcanany
                    ...
                    <!-- Api Settings -->
                    @canany(['view_all_api','view_staff_roles'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <div class="aiz-side-nav-icon">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            {{-- @can('view_all_api || view_staff_roles')
                                <li class="aiz-side-nav-item">
                            ...
                            @can('view_staff_roles')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('pathao.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['roles.index', 'roles.create', 'roles.edit'])}}">
                                        <span class="aiz-side-nav-text">{{translate('Pathao Api')}}</span>
                                    </a>
                                </li>
                            @endcan
                            @can('view_staff_roles')
                                <li class="aiz-side-nav-item">
                                    <a href="{{route('steadfast.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['roles.index', 'roles.create', 'roles.edit'])}}">
                                        <span class="aiz-side-nav-text">{{translate('Stead Fast Api')}}</span>
                                    </a>
                                </li>
                            @endcan
                            @can('view_staff_roles')
